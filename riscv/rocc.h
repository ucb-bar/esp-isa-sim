...
// ========= DEPRECATED =========
// The class below is deprecated to support multiple extensions. All extensions extending the 
// classes below will need to be rewritten before using them with other extensions at the same time
